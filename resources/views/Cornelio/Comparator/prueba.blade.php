...
@section('script')
    ...
    <script>
        ...
        function bar(data) {
            ...
            barListTotal += '   </div>';
            barListTotal += '   <div class="progress-bar progress-bar-warning" style="background-color:  #2e5cb8;width: ' + por2 + '%">';
            ...
            barList += '   <div class="progress-bar progress-bar-success" style="background-color: #990033; width: ' + por1 + '%">';
            barList += '   <span class="sr-only" style="background-color: #000000;">' + por1 + '% Complete</span><span>' + name1 + ': ' + por1.toFixed(2) + '%</span>';
            barList += '   </div>';
            barList += '   <div class="progress-bar progress-bar-warning" style="background-color:  #e68a00; width: ' + por2 + '%">';

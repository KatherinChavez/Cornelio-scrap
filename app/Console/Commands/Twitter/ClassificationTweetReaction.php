...
class ClassificationTweetReaction extends Command
{
    use ScrapTweetTrait;
    /**
     ...
     * @var string
     */
    protected $signature = 'Cornelio:ClassificationTweetReaction';
     ...
     * @var string
     */
    protected $description = 'Extracción de las reacciones de los tweets que se encuentran clasificado';

...
class TopReactionN extends Command
{
    //use TopicCountTrait;
    use SendReaction;
    /**
     ...
     * @var string
     */
    protected $signature = 'Cornelio:TopReactionN';
     ...
     * @var string
     */
    protected $description = 'Se envia un reporte de las 10 publicaciones con mas interaccion al finalizar el dia';
    ...
    public function handle()
    {
        ...
        $info   = "!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+finalizar+el+d%C3%ADa";
        $report = 4;
...
//        return $pdf->stream();
        ...
        // Se envia los datos a los que desean recibir el pdf en la noche
        $phones = NumberWhatsapp::where('subcategory_id', null)->where('report',4)->get();
        ...
        foreach ($phones as $contactoArray) {
            ...
            $mensaje = '¡Buenas+noches+'.$name.'!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+finalizar+el+d%C3%ADa';

...
class TopReactionD extends Command
{
    //use TopicCountTrait;
    use SendReaction;
    /**
     ...
     * @var string
     */
    protected $signature = 'Cornelio:TopReactionD';
     ...
     * @var string
     */
    protected $description = 'Se envia un reporte de las 10 publicaciones con mas interaccion al inciar el dia';
    ...
    public function handle()
    {
        ...
        $saludo = "¡Buenos+d%C3%adas+";
        $info   = "!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+iniciar+el+d%C3%ADa";
        $report = 1;
...
//        return $pdf->stream();
        ...
        //Se envia los datos a los que desea recibir los datos al inicio del dia
        $phones = NumberWhatsapp::where('subcategory_id', null)->where('report',1)->get();
        ...
        foreach ($phones as $contactoArray) {
            ...
            $mensaje = '¡Buenos+d%C3%adas+'.$name.'!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+iniciar+el+d%C3%ADa';

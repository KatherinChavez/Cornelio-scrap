...
class TopReactionT extends Command
{
    //use TopicCountTrait;
    use SendReaction;
    /**
     ...
     * @var string
     */
    protected $signature = 'Cornelio:TopReactionT';
     ...
     * @var string
     */
    protected $description = 'Se envia un reporte de las 10 publicaciones con mas interaccion en la tarde';
    ...
    public function handle()
    {
        ...
        $info   = "!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+terminar+la+tarde";
        $report = 3;
...
//        return $pdf->stream();
        ...
        //Se envia el pdf a los desea recibir los datos de la tarde
        $phones = NumberWhatsapp::where('subcategory_id', null)->where('report',3)->get();
        ...
        foreach ($phones as $contactoArray) {
            ...
            $mensaje = '¡Buenas+tardes+'.$name.'!+Adjunto+el+TOP+10+de+temas+con+m%C3%A1s+interacciones+en+las+Redes+Sociales+al+terminar+la+tarde';
